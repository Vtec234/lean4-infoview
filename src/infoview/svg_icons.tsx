...
export function CopyToCommentIcon(): JSX.Element {
    ...
    return <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="18" height="18" viewBox="0 0 18 18" fill="currentColor"> <g> <path d="M 5 1.5 V 5 L 9.5 4 Z" /> <rect x="9" width="10" y="3.5" height="1.5" /> <rect x="9" width="6" y="5.5" height="1" /> <rect x="9" width="8" y="7.5" height="1" /> <rect x="6" width="14" y="11" height="3" /> <path d="M 1 12.5 L 6 9.5 V 15.5 Z" /> </g> </svg>
}
...
export function ClippyIcon(): JSX.Element {
    return <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path fillRule="evenodd" clipRule="evenodd" d="M7 13.992H4v-9h8v2h1v-2.5l-.5-.5H11v-1h-1a2 2 0 0 0-4 0H4.94v1H3.5l-.5.5v10l.5.5H7v-1zm0-11.2a1 1 0 0 1 .8-.8 1 1 0 0 1 .58.06.94.94 0 0 1 .45.36 1 1 0 1 1-1.75.94 1 1 0 0 1-.08-.56zm7.08 9.46L13 13.342v-5.35h-1v5.34l-1.08-1.08-.71.71 1.94 1.93h.71l1.93-1.93-.71-.71zm-5.92-4.16h.71l1.93 1.93-.71.71-1.08-1.08v5.34h-1v-5.35l-1.08 1.09-.71-.71 1.94-1.93z"/></svg>;
}